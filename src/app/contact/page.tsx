    ...
    <InstitutionalFrame active='/contact'>
      <div className='flex items-start justify-between gap-8'>
        <div>
          ...
          <p className='mt-6 max-w-2xl text-white/65 leading-relaxed'>
            Institutional inquiries only. This platform is not a marketing channel. If you are
            looking for signing, verification, or certificate resolution, use the Authority
            Gateway.
          </p>
        </div>
      ...
      <div className='mt-10 grid gap-4 md:grid-cols-2'>
        ...
        <div className='rounded-3xl border border-white/10 bg-white/[0.02] p-8'>
          ...
          <p className='mt-4 text-sm text-white/60 leading-relaxed'>
            ...
            If referencing a record, provide a hash, envelope ID, or ledger ID so the request is
            resolvable.
          </p>
      ...
      <div className='mt-12 rounded-3xl border border-white/10 bg-white/[0.02] p-8'>
        ...
        <div className='mt-3 text-sm text-white/60 leading-relaxed'>
          Oasis operates with a public boundary. This site describes institutional posture and
          vocabulary. Execution and verification occur through the Portal.
        </div>
      </div>
    </InstitutionalFrame>
  );
